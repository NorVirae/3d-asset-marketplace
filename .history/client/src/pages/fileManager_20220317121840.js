                        ...
                        <div className="file-right">
                                ...
                                <div className="file-inner-bottom">
                                       <center> <h1>Send File</h1></center>
                                        ...
                                        <span style={{display:"flex"}}><input onChange={e=>setEmailToCopy(e.target.value)} value={emailToCopy} placeholder="click on email of user you want to send file to" style={{margin:".3rem .4rem"}} className="form-control" /></span>
