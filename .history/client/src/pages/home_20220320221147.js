...
const Home = () => {
    ...
    useEffect(()=>{
        ...
        const isLastFile = lastUploadedFileIndex === files.length
        const nextFileIndex = 
                    ...
                    <main className='main'  >
...

                        {
                            files.map((indFile, index) => {
                                ...
                                if(currentChunkIndex >= files[currentFileIndex].size / chunkSize - 1){
                                    progress = 100
                                }

                                else {
                                    progress = currentChunkIndex / (files[currentFileIndex].size / chunkSize) * 100
                                }
