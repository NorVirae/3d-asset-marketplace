                        ...
                        <div className="file-right">
                                ...
                                <div className="file-inner-bottom">
                                       <center> <h1>Send File</h1></center>
                                        ...
                                        <span style={{display:"flex", fontSize:"1.5rem", fontWeight:"1000"}}><input onChange={e=>setEmailToCopy(e.target.value)} value={emailToCopy} placeholder="click on email of user you want to send file to" style={{margin:".3rem .4rem"}} className="form-control" />E-mail of Recipient</span>
                                        <span style={{display:"flex", fontSize:"1.5rem", fontWeight:}}><input onChange={e=>setFileToCopy(e.target.value)} value={fileToCopy} placeholder="click on file to send from above" style={{margin:".3rem .4rem"}} className="form-control" />filename to send </span>
