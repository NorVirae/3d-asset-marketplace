                        ...
                        <div className="file-right">
                                ...
                                <div className="file-inner-bottom">
                                       <center> <h1>Send File</h1></center>
                                        <input onChange={e=>setEmailToCopyTo(e.target.value)} value={emailToCopyTo} placeholder="click on email of user you want to send file to" style={{margin:".3rem .4rem"}} className="form-control" />
                                        <input onChange={e=>setFileToCopy(e.target.value)} value={emailToCopyTo} placeholder="click on file to send from above" style={{margin:".3rem .4rem"}} className="form-control" />
