...
const Home = () => {
    ...
    const uploadChunk = async (readerEvent) => {
        try{
            ...
            if (currentChunkIndex === Math.ceil(file.size/chunkSize)){
    ...
    <div className="container">
                <header><Header/></header>
                    <main className='main'  >
                        <input multclassName={`dropzone ${activeDragZone?"active":""}`} onDrop={e=>handleDrop(e)} onChange={e=>handleFileInput(e)} type="file" />
