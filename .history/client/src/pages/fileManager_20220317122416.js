                        ...
                        <div className="file-right">
                                ...
                                <div className="file-inner-bottom">
                                       <center> <h1>Send File</h1></center>
                                        ...
                                        <span style={{display:"flex"}}><input onChange={e=>setFileToCopy(e.target.value)} value={fileToCopy} placeholder="click on file to send from above" style={{margin:".3rem .4rem"}} className="form-control" />filename to send </span>
