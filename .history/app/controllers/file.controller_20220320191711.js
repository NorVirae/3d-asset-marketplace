...
const uploadFile = async (req, res) => {
    ...
    try{
        ...
        const tempFileName = "tmp_"+md5(newName+req.ip);
        const firstChunk = currentChunkIndexp == 0
        const finalChunk = currentChunkIndex
        ...
        let result = fs.appendFileSync(tempFileName, buffer)
        console.log(result)
