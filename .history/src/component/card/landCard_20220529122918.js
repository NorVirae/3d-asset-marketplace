...
const WhiteList = ({color="#7c187a", degrees, left,  right, top, bottom, isTop}) =>{
    return (
        <div style={{transform: `rotate(${degrees})`, left, right, top, bottom}} className="landing__card-whiteList">
            {isTop && <BsSuitHeartFill style={{color: "#ffffff", fontSize: "1.1rem", left:"15%", top: "13%", position: "absolute"}}/>}
...
const LandCard = ({img}) => {
    ...
    return(
        <div onClick={e=>navigate("/buy/page")} onMouseEnter={e=>setActiveCard(true)} onMouseLeave={e=>setActiveCard(false)} className="landing__card">
            {activeCard && <WhiteList isTop={true} top={"-2%"} left="-2%"/>}
                        ...
                        <div className={"landing__card-body"}>
                            ...
                            <h5 className="landing__product-title-affirm">
                                ...
                                style={{color: activeCard?"#FF9700":"#6D6D91"}}>Jay Williams</span> in 3D assets
                            </h5>
                            ...
                            <div className="landing__rating-container">
                                ...
                                {activeCard && <WhiteList color={"#FF9700"} degrees={"180deg"} bottom={"10%"} right="-2%"/>}
