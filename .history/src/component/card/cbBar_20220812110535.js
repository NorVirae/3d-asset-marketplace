    ...
    return (
        // <div className="landing__cg-card-outer-container">
            <div style={style} className="landing__cg-card-container">
                ...
                <CGCard logoStyle={{fontSize: "2.9rem", pa}} textStyle={{fontSize: ".8rem"}} text={"Game-ready, VR, AR Models"} slim={slim} img={CatmanImg} />
...
export const CGBarSlim = ({style}) => {
    return <div style={style} className="landing__cg-card-container-slim">
        ...
        <CGCardSlim logoStyle={{fontSize: "2.9rem"}} textStyle={{fontSize: ".9rem"}} text={"Game-ready, VR, AR Models"} img={CatmanImg} />
