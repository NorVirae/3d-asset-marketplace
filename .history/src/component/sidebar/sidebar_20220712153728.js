    ...
    return (
        <section className="sidebar">
            ...
            <li><Link  to="contact" spy={true} smooth={true}>Contact</Link></li>
                <Link to="contact" spy={true} smooth={true}><IdentityBtn onClick={() => setActiveSidebar(1)} style={{width: "100%", borderLeft: `1rem solid ${activeSidebar == 1? "#7C187A": "#353449"}`, transform: `translateX(${activeSidebar == 1 ?"0rem": "-2rem"}) skewX(-25deg)`}} text={"WEEKLY FREEBIES"}/></Link>
