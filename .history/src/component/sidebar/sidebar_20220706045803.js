    ...
    return (
        <section className="sidebar">
            ...
            <section className="sidebar__tags">
                ...
                <IdentityBtn style={{width: "100%", borderLeft: `1rem solid ${activeSidebar}#7C187A`, transform: `translateX(${activeSidebar == 1 ?"0rem": "2rem"}) skewX(-25deg)`}} text={"WEEKLY FREEBIES"}/>
