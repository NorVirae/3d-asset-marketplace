    ...
    return (
        <section className="sidebar">
            ...
            <section className="sidebar__tags">
                ...
                <IdentityBtn onClick={() => setActiveSidebar(4)} style={{width: "100%", borderLeft: `1rem solid ${activeSidebar == 4? "#7C187A": "#353449"}`, transform: `translateX(${activeSidebar == 4 ?"0rem": "-2rem"}) skewX(-25deg)`}} text={"LATEST FREEBIES"}/>
