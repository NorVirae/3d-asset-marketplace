    ...
    return (
        <section className="sidebar">
            ...
            <section className="sidebar__tags">
                ...
                <IdentityBtn onClick={() => setActiveSidebar(3)} style={{width: "100%", borderLeft: `1rem solid ${activeSidebar == 3? "#7C187A": "#353449"}`, transform: `translateX(${activeSidebar == 3 ?"0rem": "-2rem"}) skewX(-25deg)`}} text={"ALL PRODUCTS"}/>
                <IdentityBtn onClick={() => setActiveSidebar(4)} style={{width: "100%", borderLeft: `1rem solid ${activeSidebar == 4? "#7C187A": "#353449"}`, transform: `translateX(${activeSidebar == 4 ?"0rem": "-2rem"}) skewX(-25deg)`}} text={"LATEST COLLECTIONS"}/>
                <IdentityBtn onClick={() => setActiveSidebar(5)} style={{width: "100%", borderLeft: `1rem solid ${activeSidebar == 5? "#7C187A": "#353449"}`, transform: `translateX(${activeSidebar == 5 ?"0rem": "-2rem"}) skewX(-25deg)`}} text={"LOOOTY EARN"}/>
                <IdentityBtn onClick={() => setActiveSidebar(6)} style={{width: "100%", borderLeft: `1rem solid ${activeSidebar == 6? "#7C187A": "#353449"}`, transform: `translateX(${activeSidebar == 6 ?"0rem": "-2rem"}) skewX(-25deg)`}} text={"AWESOME ARTS"}/>
