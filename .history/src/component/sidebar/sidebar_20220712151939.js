    ...
    return (
        <section className="sidebar">
            ...
            <section className="sidebar__tags">
                ...
                <IdentityBtn onClick={() => setActiveSidebar(2)} style={{width: "100%", borderLeft: `1rem solid ${activeSidebar == 2? "#7C187A": "#353449"}`, transform: `translateX(${activeSidebar == 2 ?"0rem": "-2rem"}) skewX(-25deg)`}} text={"DAILY FREEBIES"}/>
