    ...
    return (
        <section className="sidebar">
            ...
            <section className="sidebar__tags">
                ...
                <IdentityBtn onClick=style={{width: "100%", borderLeft: `1rem solid ${activeSidebar == 1? "#7C187A": "#353449"}`, transform: `translateX(${activeSidebar == 1 ?"0rem": "2rem"}) skewX(-25deg)`}} text={"WEEKLY FREEBIES"}/>
