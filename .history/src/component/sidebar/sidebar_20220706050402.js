    ...
    return (
        <section className="sidebar">
            ...
            <section className="sidebar__tags">
                ...
                <IdentityBtn onClick={() => setActiveSidebar(2)} style={{width: "100%", borderLeft: `1rem solid ${activeSidebar == 2? "#7C187A": "#353449"}`, transform: `translateX(${activeSidebar == 2 ?"0rem": "2rem"}) skewX(-25deg)`}} text={"WEEKLY FREEBIES"}/>
                ...
                <IdentityBtn onClick={() => setActiveSidebar(4)} style={{width: "100%", borderLeft: `1rem solid ${activeSidebar == 4? "#7C187A": "#353449"}`, transform: `translateX(${activeSidebar == 1 ?"0rem": "2rem"}) skewX(-25deg)`}} text={"WEEKLY FREEBIES"}/>
                <IdentityBtn onClick={() => setActiveSidebar(5)} style={{width: "100%", borderLeft: `1rem solid ${activeSidebar == 5? "#7C187A": "#353449"}`, transform: `translateX(${activeSidebar == 1 ?"0rem": "2rem"}) skewX(-25deg)`}} text={"WEEKLY FREEBIES"}/>
                <IdentityBtn onClick={() => setActiveSidebar(6)} style={{width: "100%", borderLeft: `1rem solid ${activeSidebar == 6? "#7C187A": "#353449"}`, transform: `translateX(${activeSidebar == 1 ?"0rem": "2rem"}) skewX(-25deg)`}} text={"WEEKLY FREEBIES"}/>
