    ...
    return (
        <section className="sidebar">
            ...
            <section className="sidebar__tags">
                ...
                <IdentityBtn onClick={() => setActiveSidebar(2)} style={{width: "100%", borderLeft: `1rem solid #353449`}} text={"WEEKLY FREEBIES"}/>
                <IdentityBtn onClick={() => setActiveSidebar(3)} style={{width: "100%", borderLeft: `1rem solid #353449`}} text={"WEEKLY FREEBIES"}/>
                ...
                <IdentityBtn onClick={() => setActiveSidebar(1)} style={{width: "100%", borderLeft: `1rem solid #353449`}} text={"WEEKLY FREEBIES"}/>
