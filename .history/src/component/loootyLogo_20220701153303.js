...
export const LoootyLogoSplit = ({style, color="#8383b2"}) => {
    return (
        ...
        {/* <polygon name style={{fill: color}} points="791.15 170.35 768.06 220.11 768 220.11 758.51 240.41 678.1 240.41 687.51 220.11 687.42 220.11 710.32 170.35 791.15 170.35"/> */}
