...
export const LoootyLogoSplit = ({style, color="#8383b2"}) => {
    return (
        ...
        <polygon style={{fill: color}} points="253.71 276.37 215.21 359.49 79.99 359.49 118.73 276.37 253.71 276.37"/>
        ...
        <polygon name="" style={{fill: color}} points="887.68 181.28 860.31 240.41 791.82 240.41 887.68 181.28"/>
    </svg> 
</div>  )
}
