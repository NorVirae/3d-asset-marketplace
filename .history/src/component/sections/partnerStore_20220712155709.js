...
const PartnerStore = () => {
    ...
    return (<section className="landing__open-partner-container">
                ...
                <div className="landing__open-partner-inner-container">
                   ...
                   {!partnerOpen && <ListExplainLeft  style={{left: "4.2%", width: "30%", 
                    alignItems: "flex-end",
                    clipPath: "polygon(100% 100%, 0 100%, 0% 100%, 0% 0, 105% 0)",
                   ...
                   <div onMouseEnter={e=>setPartnerOpen(false)} className="landing__open-img-container">
                    ...
                    <div style={{left: partnerOpen? "20%":"16%"}} className="landing__open-partner-label-container">
