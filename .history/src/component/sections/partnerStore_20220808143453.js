...
const ListExplainLeft = ({style}) => {
    return (
        <section style={style} className="landing__partner-store-discuss landing__partner-store-discuss-left">
                                <div className="landing__first-col-container">
...
const PartnerStoreDesktop = () => {
    ...
    return (<section className="landing__open-partner-container">
                ...
                <div className="landing__open-partner-inner-container">
                   ...
                   {!partnerOpen && <ListExplainLeft  style={{left: "6.8%", width: "30%", 
                    alignItems: "flex-end",
                   ...
                   <div onMouseEnter={e=>setPartnerOpen(false)} className="landing__open-img-container">
                    ...
                    <div style={{left: partnerOpen? "20%":"22%"}} className="landing__open-partner-label-container">
...
const PartnerStore = () => {
    ...
    return (<section className="landing__open-partner-container">
                ...
                <div style={{transform: "scale(.3"}} className="landing__open-partner-inner-container">
                   {partnerOpen && <ListExplainRight />}
                   {!partnerOpen && <ListExplainLeft  style={{left: "6.8%", width: "30%", 
                    alignItems: "flex-end",
                    clipPath: "polygon(100% 100%, 0 100%, 5% 100%, 0% 0, 105% 0)",
