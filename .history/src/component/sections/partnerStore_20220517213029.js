                ...
                <div className="landing__open-partner-inner-container">
                   ...
                   <div onMouseEnter={e=>setPartnerOpen(false)} className="landing__open-img-container">
                    ...
                    <div style={{left: partnerOpen? "20%":"10%"}} className="landing__open-partner-label-container">
                        <div style={{backgroundColor: partnerOpen? "#fff":"black"}} className="landing__bg-label-partner">
                            Open a Store
                        ...
                        <div style={{backgroundColor: !partnerOpen? "#fff":"black", opacity: !partnerOpen? "#fff":"black",}} className="landing__bg-label-open">
                            Become a partner
