...
export const LoootyLogoSplit = ({style, color="#8383b2"}) => {
    return (
        ...
        <polygon name="" style={{fill: color}} points="828.9 308.27 823.03 320.94 823.05 320.94 805.26 359.51 725.18 359.51 775.82 250.28 791.82 240.41 860.31 240.41 828.9 308.27"/>
