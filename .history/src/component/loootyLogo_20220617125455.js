                ...
                <svg style={{height: "100%", width: "100%"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 123.32 77.72">
                    ...
                    <g id="Layer_2" data-name="Layer 2">
                        <g id="Layer_1-2" data-name="Layer 1">
                           ...
                           {yScroll > 100 && <polygon points="111.41 22.8 97.41 31.43 91.18 45.08 108.11 45.08 93.05 77.72 104.07 75.61 123.32 33.55 113.26 33.55 110.18 40.23 103.48 40.23 111.41 22.8" style={{fill: logoCol}}/>}
                        </g>
                    </g>
                </svg>
    </div>
