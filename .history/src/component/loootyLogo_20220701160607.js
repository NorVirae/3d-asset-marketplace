    ...
    return (
        <div style={{ width: "7rem", height: "100%", alignItems: "center", display:"flex", justifyContent:"center", ...style}} className="loooty-logo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 982.89 619.25">
                ...
                <polygon name="l-bottom-right" style={{fill: color, transform: `translate(${textParts.lBottomRight.x}, 4rem)`}} points="253.71 276.37 215.21 359.49 79.99 359.49 118.73 276.37 253.71 276.37"/>
