...
export const LoootyLogo = ({style, color="#8383b2"}) => {
    ...
    return (
        <div style={{ width: "7rem", height: "100%", alignItems: "center", display:"flex", zIndex: 44, position: "absolute", left: "50%", top: "50%" ,justifyContent:"center", ...style}} className="loooty-logo">
