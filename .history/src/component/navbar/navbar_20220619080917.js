...
const NavBar = ({search, style, shortSearch, loggedIn}) => {
    ...
    return (
        <nav style={{...style, background: `${yScroll>50?"#232230": "transparent"}`, padding: `${yScroll > 50? "1rem": "2rem"}`, width: `${yScroll > 400? "80vw": "100%"}`, right: "0%", position: `${yScroll > 400? "fixed": "sticky"}`}} className="landing__navbar">
