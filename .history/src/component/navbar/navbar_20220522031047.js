...
const NavBar = () => {
    ...
    return (
        <nav className="landing__navbar">
                    <Link className="landing__navbar-brand" to = "/"><LoootyLogo style={{height: "10px"}}/></Link>

                    <ul className="landing__navbar-inner-container">
                        <li className={"landing__nav-item"}>
                            <Link onClick={e=>setShowRegModal({...showRegModal, openstore:!showRegModal.openStore})} className="landing__nav-link" to={"#"}>Open a Store</Link>
                        </li>
