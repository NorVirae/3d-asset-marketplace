...
const NavLoggedIn = () => {
    return (
        <ul className="landing__navbar-inner-container">
            <li className="landing__navbar-logo-items">settings</li>
            <li className="landing__navbar-logo-items">notify</li>
            <li className="landing__navbar-logo-items">message</li>
