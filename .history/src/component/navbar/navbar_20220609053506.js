...
const NavLoggedIn = () => {
    return (
        <ul className="landing__navbar-inner-container">
            <li className="landing__navbar-settings">settings</li>
            <li className="landing__navbar-notify">notify</li>
            <li className="landing__navbar-message">message</li>
            <li className="landing__navbar-profile-container">settings</li>
