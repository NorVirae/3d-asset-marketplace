...
const NavBar = ({search, style, shortSearch, loggedIn}) => {
    ...
    return (
        <nav style={{...style, background: `${yScroll>50?"#232230": "transparent"}`, padding: `${yScroll > 50? "1rem": "2rem"}`, width: `${setShowRegModal.isSidebarOpen? "82vw": "82vw"}`, right: `${setShowRegModal.isSidebarOpen? "-19%": "-15%"}`, position: `${yScroll > 400? "fixed": "sticky"}`}} className="landing__navbar">
