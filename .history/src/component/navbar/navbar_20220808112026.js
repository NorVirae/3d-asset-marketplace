...
const NavBar = ({search, style, shortSearch, loggedIn}) => {
    ...
    return (
        <nav style={{...style, background: `${yScroll>50?"#232230": "transparent"}`, width: `${isMobile?nusetShowRegModal.isSidebarOpen? "82vw": "100%"}`, right: `${setShowRegModal.isSidebarOpen? "-19%": "0%"}`, position: `${yScroll > 400? "fixed": "sticky"}`}} className="landing__navbar">
