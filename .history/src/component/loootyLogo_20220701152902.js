...
export const LoootyLogoSplit = ({style, color="#8383b2"}) => {
    return (
        ...
        <polygon name="y-bottom" style={{fill: color}} points="982.89 267.79 940.33 359.57 860.26 359.57 860.29 359.51 860.27 359.51 878.13 320.94 878.16 320.94 902.8 267.79 982.89 267.79"/>
