...
export const LoootyLogo = ({style, color="#8383b2"}) => {
    ...
    return (
        <div style={{ width: "7rem", height: "100%", alignItems: "center", transition: "margin-left .7s ease-in-out", display:"flex", justifyContent:"center", ...style}} className="loooty-logo">
