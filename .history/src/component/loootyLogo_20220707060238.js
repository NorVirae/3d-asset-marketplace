    ...
    return (
        <div style={{ width: "7rem", height: "100%", alignItems: "center", display:"flex", justifyContent:"center", ...style}} className="loooty-logo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 982.89 619.25">
                ...
                <polygon className="logo__anim" name="l-bottom-right" style={{display:`${}` ,fill: color, transform: `scale(${textParts.lBottomRight.scaleX}, ${textParts.lBottomRight.scaleY}) translate(${textParts.lBottomRight.x}rem, ${textParts.lBottomRight.y}rem)`}} points="253.71 276.37 215.21 359.49 79.99 359.49 118.73 276.37 253.71 276.37"/>
                <polygon className="logo__anim" name="l-bottom-left" style={{display:`$fill: color,  transform: `scale(${textParts.lBottomLeft.scaleX}, ${textParts.lBottomLeft.scaleY}) translate(${textParts.lBottomLeft.x}rem, ${textParts.lBottomLeft.y}rem)`}} points="118.73 276.37 79.99 359.49 0 359.49 38.5 276.37 118.73 276.37"/>
