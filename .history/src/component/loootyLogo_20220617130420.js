                ...
                <svg style={{height: "100%", width: "100%"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 123.32 77.72">
                    ...
                    <g id="Layer_2" data-name="Layer 2">
                        <g id="Layer_1-2" data-name="Layer 1">
                            <polygon className={`logo__hide-in ${yScroll > 100?"logo__in": "logo__out"}`} points="17.83 6.27 0 45.08 27.05 45.08 31.89 34.63 14.92 34.63 30.77 0 17.83 6.27" style={{fill: logoCol}}/>
                            ...
                            {yScroll > 100 && <polygon className={`logo__hide-in ${yScroll > 100?"logo__in": "logo__out"}`} points="92.56 13.81 89.15 21.3 79.33 21.3 76.41 27.56 86.3 27.56 78.29 45.08 88.34 45.08 96.36 27.56 99.88 27.54 110.1 21.3 99.21 21.3 105.63 7.33 92.56 13.81" style={{fill: logoCol}}/>}
                           {yScroll > 100 && <polygon className={`logo__hide-in ${yScroll > 100?"logo__in": "logo__out"}`} points="111.41 22.8 97.41 31.43 91.18 45.08 108.11 45.08 93.05 77.72 104.07 75.61 123.32 33.55 113.26 33.55 110.18 40.23 103.48 40.23 111.41 22.8" style={{fill: logoCol}}/>}
                        </g>
                    </g>
                </svg>
    </div>
