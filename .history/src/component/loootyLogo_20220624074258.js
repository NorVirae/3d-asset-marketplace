...
export const LoootyLogoSplit = ({style, color="#8383b2"}) => {
    return (
        ...
        <polygon style={{fill: color, transform: "translateY(10rem)"}} points="253.71 276.37 215.21 359.49 79.99 359.49 118.73 276.37 253.71 276.37"/>
        <polygon style={{fill: color}} points="118.73 276.37 79.99 359.49 0 359.49 38.5 276.37 118.73 276.37"/>
        <polygon style={{fill: color}} points="174.03 156.84 118.94 275.92 118.73 276.37 38.5 276.37 93.85 156.84 174.03 156.84"/>
        <polygon style={{fill: color}} points="246.59 0 174.03 156.84 93.85 156.84 143.31 50.05 246.59 0"/>
        ...
        <polygon style={{fill: color}} points="758.51 240.41 702.82 359.49 622.91 359.49 678.1 240.41 758.51 240.41"/>
        <polygon style={{fill: color}} points="791.15 170.35 768.06 220.11 768 220.11 758.51 240.41 678.1 240.41 687.51 220.11 687.42 220.11 710.32 170.35 791.15 170.35"/>
        <polygon style={{fill: color}}points="710.32 170.35 687.42 220.11 607.95 220.11 631.12 170.35 710.32 170.35"/>
        <polygon style={{fill: color}} points="875.95 170.35 794.64 219.97 768.06 220.11 791.15 170.35 875.95 170.35"/>
        <polygon style={{fill: color}} points="843.15 57.76 791.03 170.35 710.58 170.35 738.66 109.61 843.15 57.76"/>
        <polygon style={{fill: color}} points="828.9 308.27 823.03 320.94 823.05 320.94 805.26 359.51 725.18 359.51 775.82 250.28 791.82 240.41 860.31 240.41 828.9 308.27"/>
        <polygon style={{fill: color}} points="878.13 320.94 860.27 359.51 805.26 359.51 823.05 320.94 878.13 320.94"/>
        <polygon style={{fill: color}} points="982.89 267.79 940.33 359.57 860.26 359.57 860.29 359.51 860.27 359.51 878.13 320.94 878.16 320.94 902.8 267.79 982.89 267.79"/>
        <polygon style={{fill: color}} points="940.33 359.57 885.14 478.58 805.16 478.58 860.26 359.57 940.33 359.57"/>
        <polygon style={{fill: color}} points="885.14 478.58 827.72 602.41 740.02 619.25 805.16 478.58 885.14 478.58"/>
        <polygon style={{fill: color}} points="887.68 181.28 860.31 240.41 791.82 240.41 887.68 181.28"/>
    </svg> 
</div>  )
}
