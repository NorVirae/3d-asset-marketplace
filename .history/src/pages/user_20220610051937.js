...
const User = () => {
    ...
    return (
        <section>
            <header>
                <NavBar loggedIn={true} shortSearch={true} style={{paddingBottom: "0", paddingBottom: "0"}} search={true}/>
            ...
            <main>
                <section className="user__profile-preview-container">
                    ...
                    <button className="user__profile-switch-admin-btn">
                        <span>Switch Admin Mode</span>
                    </button>
