...
const OrderCheckbox = ({isActive, setIsActive}) => {
    const [, ] = useState(true)
    return (
        <div onClick={() => } className="user__main-sett-checkbox">
            <div style={{backgroundColor: `${isActive && "transparent"}`}} className="user__main-sett-checkbox-active">
                ...
                <section className="user__main-sett-container">
                    ...
                    <div className="user__main-sett-body">
                        <div className="user__main-sett-body-left">
                            <div className="user__main-sett-item">
                        ...
                        <div className="user__main-sett-body-right">
