            ...
            <div className="landing__app-container">
                ...
                <main className="landing__main">
                        ...
                        <section className="landing__cg-tutorials">
                            {yScroll > 1000?<CGBarSlim style={{position: `${yScroll > 1000? "fixed":"sticky"}`,}/>:<CGBar 
                            // style={{position: `${yScroll > 1000? "fixed":"sticky"}`, backgroundColor:`${showRegModal.isSidebarOpen? "": "#15151C"}`, margin: `${showRegModal.isSidebarOpen || yScroll > 1000? "1rem auto": "1rem"}`, maxWidth: `${showRegModal.isSidebarOpen && yScroll > 1000? "80vw": "100%"}`}}
                             />}
                        </section>
