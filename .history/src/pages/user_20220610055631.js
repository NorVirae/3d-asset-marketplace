        ...
        <section>
            ...
            <main>
                ...
                <section className="user__admin-page-section-header-container">
                    ...
                    <IdentityBtn onClick={e=>setActiveInPageHeader("store")} style={{padding: "1rem 6rem", width borderLeft: `1rem solid ${activeInpageHeader==="store"?"#7C187A":"#353449"}`}} dropDownList={true} text={"STORE"}/>
