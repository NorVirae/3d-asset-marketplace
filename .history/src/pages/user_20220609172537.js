...
const User = () => {
    ...
    const [selectedTagsetSelectedTag]
    return (
        <section>
            <header>
            ...
            <main>
                ...
                <section className="user__tags-container">
                    <div className="user__feature-tags-container">
                        <span onClick={e=>setSelectedTag("feature")} className="user__feature-tags-item user__feature-tags-item-active"> FEATURED</span>
                        <span onClick={e=>setSelectedTag("recent")}  className="user__feature-tags-item"> RECENT</span>
                        <span onClick={e=>setSelectedTag("recent")} className="user__feature-tags-item"> BEST SELLERS</span>
