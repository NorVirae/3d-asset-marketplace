            ...
            <div className="landing__app-container">
                ...
                <main className="landing__main">
                        ...
                        <section className="landing__cg-tutorials">
                            <CGBar style={{position: `${yScroll > 1040? "fixed":"sticky"}`, backgroundColor:`${showRegModal.isSidebarOpen? "": "#15151C"}`, maxWidth: `${showRegModal.isSidebarOpen && yScroll > 1040? "80vw": "100%"}`, width: `${showRegModal.isSidebarOpen && yScroll > 1040? "80vw": "100%"}`}} />
                        </section>
