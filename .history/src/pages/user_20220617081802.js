            ...
            <div className="user__settings-inner">
                <section className="user__settings-sidebar">
                    ...
                    <section className="user__settings-sidebar-body">
                        ...
                        <SettingsItem itemName={"Notification"} onClick={() => setActiveSideUser(1)} active={activeSideUser === 1}/>
                        <SettingsItem itemName={"Notification"} onClick={() => setActiveSideUser(2)} active={activeSideUser === 2}/>
