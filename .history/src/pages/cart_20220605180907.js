                    ...
                    <section className="cart__payment-gateway-container">
                        <div className="cart__gateway-options-container">
                            ...
                            <form className="cart__card-insertion-container">
                                ...
                                <div style={{backgroundColor: "red", justifyContent: "center"}} className="buy__purchase-btn-container">
                                    <button style={{width: "50%", justifyContent: "center"}} onClick={e=>navigate("/cart")} className="buy__purchase-btn">
