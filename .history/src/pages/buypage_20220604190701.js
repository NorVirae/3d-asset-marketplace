        ...
        <div className="buy__cart-buy-container">
            ...
            <div className="buy__cart-purchase-main-container">
                <div className="buy__purchase-btn-container">
                    <button className="buy__purchase-btn"><span style={{transform: "SkewX(20deg)"}}>BUY NOW </span> </button>
                ...
                <div className="buy__payment-methods-container">
                    <p style={{color: "#6D6D91", fontSize: "1rem"}}>Payment made easy! You can pay with any of this payment system:</p>
