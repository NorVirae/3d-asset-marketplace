...
const SettingsItem = ({onClick, active= false}) => {
    return (
        <button onClick={onClick} className={`user__settings-friend ${active && "user__settings-friend-active"}`}>
            <div className="user__settings-friend-inner">
                <FcSettings />
                <div className="user__settings-friend-body">
                    <h5 className="user__settings-friend-name">
                        Clement Seyfried
                    </h5>
                </div>
            </div>
            ...
            <div className="user__settings-inner">
                <section className="user__settings-sidebar">
                    ...
                    <section className="user__settings-sidebar-body">
                        <SettingsItem onClick={() => setActiveSideUser(0)} active={activeSideUser === 0}/>
                        <SettingsItem onClick={() => setActiveSideUser(1)} active={activeSideUser === 1}/>
                        <SettingsItem onClick={() => setActiveSideUser(2)} active={activeSideUser === 2}/>
