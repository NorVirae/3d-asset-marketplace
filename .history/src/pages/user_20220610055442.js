        ...
        <section>
            ...
            <main>
                ...
                <section className="user__admin-page-section-header-container">
                    ...
                    <IdentityBtn style={{padding: "1rem 6rem", borderLeft: `1rem solid ${activeInpageHeader==="library"?"#7C187A":"#353449"}`}} text={"LIBRARY"}/>
                    <IdentityBtn style={{padding: "1rem 6rem", borderLeft: `1rem solid ${activeInpageHeader==="messages"?"#7C187A":"#353449"}`}} text={"MESSAGES"}/>
                    <IdentityBtn style={{padding: "1rem 6rem", borderLeft: `1rem solid ${activeInpageHeader==="sales"?"#7C187A":"#353449"}`}} text={"SALES"}/>
                    <IdentityBtn style={{padding: "1rem 3rem", borderLeft: `1rem solid ${activeInpageHeader==="settings"?"#7C187A":"#353449"}`}} text={"SETTINGS"}/>
