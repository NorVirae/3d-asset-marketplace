            ...
            <main className="landing__main">
                    ...
                    <section style={{height: "15vh"}} className="landing__weekly-freebies-container">
                            ...
                            <div className="landing__daily-picks-filters-container">
                                <button style={{backgroundColor: "#1D1D28", color:"#3E3E4F"}} className="landing__daily-picks-filters-btn">
                                    <span style={{transform: "skewX(25deg"}}>POPULAR</span>
                                </button>
                                <button style={{backgroundColor: "#15151C", color:"#ffffff"}} className="landing__daily-picks-filters-btn">
