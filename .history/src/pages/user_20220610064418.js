    ...
    return (
        <div className="user__main-profile-form-group">
            <label className="user__main-profile-label">
                <span className={"user__main-profile-label-inner"}FIRST NAME
            </label>
...
const User = () => {
    ...
    const [activeInpageHeader, setActiveInPageHeader] = useState('profile')//Enum types: store, profile, library, messages, sales, settings
    return (
        <section>
            <header>
