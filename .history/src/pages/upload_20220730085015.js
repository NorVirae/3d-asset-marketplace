            ...
            <section className="upload__description-section">
                ...
                <section className="upload__price-section">
                    <div className="upload__price-inner-section">
                        ...
                        <div disabled={true} className={`upload__form-group ${isCommercialActive && "upload__form-group-commercial-inactive"}`}>
                            
                            
                            <span className="upload__license-text upload__form-group-commercial "><OrderCheckbox isActive={isCommercialActive} setIsActive={setIsCommercialActive} /> Commercial License</span>
                            <section className="upload__skew-container">
                                <div className="upload__main-control-container">
                                    <div className="upload__control-switch-container">
                                        <button className="upload__control-usd-btn">
                                        ...
                                        <input disabled={!isCommercialActive} className="upload__price-input" />
                                    </div>
                                </div>
                                
                                <div className="upload__container-controller">
                                    <button disabled={!isCommercialActive} className="upload__controller-btn"><span><FaPlus/></span></button>
                                    <button disabled={!isCommercialActive} className="upload__controller-btn"><span><FaMinus/></span></button>
                                </div>
                            </section>
                        </div>
