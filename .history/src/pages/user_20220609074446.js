            ...
            <main>
                ...
                <section className="user__product-action-container">
                    ...
                    <div className="user__admin-visitor-container">
                        <button onClick={e=>toggleVisAdmin(true)} className={`user__AV-btn ${toggleVisAdmin && "user_AV-btn-active"}`}>
                            <span className="user__AV-btn-inner">Admin</span>
                        </button>
                        <button onClick={e=>toggleVisAdmin(false)} className={`user__AV-btn ${toggleVisAdmin && "user_AV-btn-active"}`}>
