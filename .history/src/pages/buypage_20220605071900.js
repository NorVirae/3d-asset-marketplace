...
const FilePurchaseSec = () => {
    const [descCommToggleMode, setDescCommToggleMode] = useState(false)
    return (
            ...
            <div className="buy__file-info-container">
                <section className="buy__file-attributed-container">
                    ...
                    <div className="buy__comment-header">
                        <IdentityBtn onClick={e=>setDescCommToggleMode(true)} style={{backgroundColor: descCommToggleMode?"#232230": "#15151C", borderLeft:`.5rem solid ${descCommToggleMode?"#7C187A":}`, padding:".5rem 4rem"}} text={"Description"} />
                        <IdentityBtn onClick={e=>setDescCommToggleMode(false)} style={{backgroundColor: !descCommToggleMode?"#232230": "#15151C", borderLeft:`.5rem solid ${#7C187A}`, padding:".5rem 4rem"}} text={"18 comments"} />
                    </div>
