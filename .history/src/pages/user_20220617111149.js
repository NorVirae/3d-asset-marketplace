...
const LibraryItem = ({onClick, active= false, itemName}) => {
    return (
        <button onClick={onClick} className={`user__library-item ${active && "user__library-item-active"}`}>
            <div className="user__library-item-inner">
                { active ? <ImFolderOpen className="user__lib-folder-large" style={{fontSize: "2rem"}}/>:
                <ImFolder  className="user__lib-folder-large" style={{fontSize: "2rem"}}/>}
            ...
            <div className="user__library-inner">
                ...
                <section className="user__library-sidebar">
                    ...
                    <section className="user__library-sidebar-body">
                        ...
                        <LibraryItem itemName={"Notification"} onClick={() => setActiveSideUser(0)} active={activeSideUser === 0}/>
                        <LibraryItem itemName={"Account"} onClick={() => setActiveSideUser(1)} active={activeSideUser === 1}/>
                        <LibraryItem itemName={"Messaging"} onClick={() => setActiveSideUser(2)} active={activeSideUser === 2}/>
                        <LibraryItem itemName={"Password"} onClick={() => setActiveSideUser(3)} active={activeSideUser === 3}/>

                    </section>

                    <section className="user__library-sidebar-footer">
                        <button className="user__library-trash-btn">
                            <FcSettings  className="user__library-trash-btn-logo"/> 
                            <span className="user__library-trash-btn-text">STORE</span>
                        </button>
                    </section>
                </section>
