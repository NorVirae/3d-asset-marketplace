                ...
                <section className="cart__inner-container">
                    <section className="cart__items-container">
                        ...
                        <div className="cart__cart-items-container">
                            <CartItem setCheckboxActiveItems={setCheckboxActiveItems} checkIndex checkBoxActive={checkboxActiveItems[0]}/>
                            <CartItem setCheckboxActiveItems={setCheckboxActiveItems} checkBoxActive={checkboxActiveItems[1]}/>
                            <CartItem setCheckboxActiveItems={setCheckboxActiveItems} checkBoxActive={checkboxActiveItems[2]}/>
                            <CartItem setCheckboxActiveItems={setCheckboxActiveItems} checkBoxActive={checkboxActiveItems[3]}/>
                            <CartItem setCheckboxActiveItems={setCheckboxActiveItems} checkBoxActive={checkboxActiveItems[4]}/>
                            <CartItem setCheckboxActiveItems={setCheckboxActiveItems} checkBoxActive={checkboxActiveItems[5]}/>
                            <CartItem setCheckboxActiveItems={setCheckboxActiveItems} checkBoxActive={checkboxActiveItems[6]}/>
