        ...
        <div className="landing__app-container">
            ...
            <main className="landing__main">
                    ...
                    <section className="landing__weekly-freebies-container">
                            ...
                            <div className="landing__daily-picks-filters">
                                <button className="landing__daily-picks-filters">
                                    <span style={{transform: "rotate(-25deg"}}>POPULAR</span>
                                </button>
                                <button className="landing__daily-picks-filters">
                                    <span style={{transform: "rotate(-25deg"}}>RECENT</span>
                                </button>
                                <button className="landing__daily-picks-filters">
                                    <span style={{transform: "rotate(-25deg"}}>FREEBIES</span>
                                </button>
                                <button className="landing__daily-picks-filters">
                                    <span style={{transform: "rotate(-25deg"}}>ONSALE&AM</span>
                                </button>
