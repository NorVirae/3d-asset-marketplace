...
const Settings = () => {
    const [activeSideUser, setActiveSideUser] = useState(0)
    const settingsItems = span clas[<sName="user__settings-sidebar-header-item-text">"Notification"</span>,
     "Account", "Messaging", "Password", "User Name", "Blocking", "Payment", "Store", "Profile", "Sales"]
    return (
