            ...
            <div className="user__library-inner">
                ...
                <section className="user__library-sidebar">
                    ...
                    <section className="user__library-sidebar-body">
                        ...
                        <LibraryItem prodNumber={21} itemName={"New Folder(1)"} onClick={() => setActiveSideUser(1)} active={activeSideUser === 1}/>
                        <LibraryItem prodNumber={21} itemName={"New Folder(2)"} onClick={() => setActiveSideUser(2)} active={activeSideUser === 2}/>
                        <LibraryItem prodNumber={21} itemName={"Loooty backup"} onClick={() => setActiveSideUser(3)} active={activeSideUser === 3}/>
