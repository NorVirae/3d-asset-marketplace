...
const User = () => {
    ...
    const [activeInpageHeader, setActiveInPageHeader] = useState('store')//Enum types: store, profile, library, messages, sales, settings
    return (
        <section>
            <header>
            ...
            <main>
                ...
                <section className="user__admin-page-section-header-container">
                    ...
                    <IdentityBtn onClick={e=>setActiveInPageHeader("store")} style={{padding: "1rem 6rem", width: "20%", borderLeft: `1rem solid ${activeInpageHeader==="store"?"#7C187A":"#353449"}`}} dropDownList={true} text={"STORE"}/>
                    <IdentityBtn onClick={e=>setActiveInPageHeader("profile")} style={{padding: "1rem 6rem", borderLeft: `1rem solid ${activeInpageHeader==="profile"?"#7C187A":"#353449"}`}} text={"PROFILE"}/>
                    <IdentityBtn onClick={e=>setActiveInPageHeader("library")} style={{padding: "1rem 6rem", borderLeft: `1rem solid ${activeInpageHeader==="library"?"#7C187A":"#353449"}`}} text={"LIBRARY"}/>
                    <IdentityBtn onClick={e=>setActiveInPageHeader("messages")} style={{padding: "1rem 6rem", borderLeft: `1rem solid ${activeInpageHeader==="messages"?"#7C187A":"#353449"}`}} text={"MESSAGES"}/>
                    <IdentityBtn onClick={e=>setActiveInPageHeader("sales")} style={{padding: "1rem 6rem", borderLeft: `1rem solid ${activeInpageHeader==="sales"?"#7C187A":"#353449"}`}} text={"SALES"}/>
                    <IdentityBtn onClick={e=>setActiveInPageHeader("settings")} style={{padding: "1rem 3rem", borderLeft: `1rem solid ${activeInpageHeader==="settings"?"#7C187A":"#353449"}`}} text={"SETTINGS"}/>
