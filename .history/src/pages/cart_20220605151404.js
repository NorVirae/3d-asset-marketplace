...
const CartItem = () => {
    return (
        <div className="cart__cart-item">
            ...
            <div className="cart__item-title cart__cart-item-border-right">Beach House with Rumps</div>
            <div className="cart__item-license-type cart__cart-item-border-right">Commercial License</div>
            <button className="cart__item-price-btn cart__cart-item-border-right">$500</button>
