...
const Library = () => {
    ...
    const settingsItems = ["Notification", "New Folder(1)", "New Folder(2)", "Loooty backup", "User Name", "Blocking", "Payment", "Store", "Profile", "Sales"]
    return (
        <section className="user__library">
            <div className="user__library-inner">
                ...
                <section className="user__library-sidebar">
                    ...
                    <section className="user__library-sidebar-body">
                        ...
                        <LibraryItem itemName={"All Products"} onClick={() => setActiveSideUser(0)} active={activeSideUser === 0}/>
                        <LibraryItem itemName={"New Folder(1)"} onClick={() => setActiveSideUser(1)} active={activeSideUser === 1}/>
                        <LibraryItem itemName={"New Folder(2)"} onClick={() => setActiveSideUser(2)} active={activeSideUser === 2}/>
                        <LibraryItem itemName={"Loooty backup"} onClick={() => setActiveSideUser(3)} active={activeSideUser === 3}/>
