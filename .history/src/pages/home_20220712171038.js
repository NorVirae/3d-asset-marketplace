...
const Home = () => {
    ...
    const closeSidebarWithDelay = () => {
        const timeout = setTimeout(2000, () => {
            console.log("CALLESD")
            setShowRegModal(old => ({...old, isSidebarOpen: false}))
    ...
    return (
        <section className="landing__main-app">
            ...
            <div className="landing__app-container">
                { showRegModal.isSidebarOpen && <section onClick={() => closeSidebarWithDelay()} className="landing__overlay"></section>}
                ...
                <main className="landing__main">
                        ...
                        <section className="landing__cg-tutorials">
                            <CGBar style={{position: `${yScroll > 1000? "fixed":"sticky"}`, backgroundColor:`${showRegModal.isSidebarOpen? "": "#15151C"}`, margin: `${showRegModal.isSidebarOpen || yScroll > 1000? "1rem auto": "1rem"}`, maxWidth: `${showRegModal.isSidebarOpen && yScroll > 1000? "80vw": "100%"}`}} />
                        </section>
