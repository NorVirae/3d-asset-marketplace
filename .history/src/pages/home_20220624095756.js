            ...
            <div className="landing__app-container">
                ...
                <main className="landing__main">
                        ...
                        <section className="landing__cg-tutorials">
                            <CGBar style={{position: `${yScroll > 1010? "fixed":"sticky"}`, backgroundColor:`${showRegModal.isSidebarOpen? "": "#15151C"}`, margin: `${showRegModal.isSidebarOpen || yScroll > 1000? "1rem auto": "1rem"}`, maxWidth: `${showRegModal.isSidebarOpen && yScroll > 1000? "80vw": "100%"}`}} />
                        </section>
