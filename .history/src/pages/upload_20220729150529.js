            ...
            <section className="upload__description-section">
                ...
                <section className="upload__tags-container">
                    ...
                    <section className="upload__tags-inner-container">
                        ...
                        <MainTags text="Games" defaultState={false}/>
                        <MainTags text="Anime" defaultState={false}/>
                        <MainTags text="2D Assets" defaultState={false}/>
                        <MainTags text="compose" defaultState={false}/>
                        <MainTags text="Cinema" defaultState={false}/>
                        <MainTags text="Mesh" defaultState={false}/>
                        <MainTags text="Topo" defaultState={false}/>
                    </section>
                </section>
