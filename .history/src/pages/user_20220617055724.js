...
const MessageFriend = ({active= false}) => {
    return (
        <button className={`user__message-friend ${active && "user__message-friend-active"}`}>
...
const ReceiverMsg = () => {
    return (
        <section className="user__main-receiver-msg-cont">
            ...
            <img className="user__main-receiver-msg-img" src={CatmanImg} alt="" />
            ...
            <div className="user__messages-inner">
                <section className="user__message-sidebar">
                    ...
                    <section className="user__message-sidebar-body">
                        ...
                        <MessageFriend onClick={() => setActiveSideUser(1)} active={activeSideUser === 0}/>
                        <MessageFriend onClick={() => setActiveSideUser(1)} active={activeSideUser === 2}/>
