            ...
            <div className="user__settings-inner">
                <section className="user__settings-sidebar">
                    ...
                    <section className="user__settings-sidebar-body">
                        ...
                        <SettingsItem itemName={"Password"} onClick={() => setActiveSideUser(2)} active={activeSideUser === 2}/>
                        <SettingsItem itemName={"User Name"} onClick={() => setActiveSideUser(2)} active={activeSideUser === 2}/>
                        <SettingsItem itemName={"Blocking"} onClick={() => setActiveSideUser(2)} active={activeSideUser === 2}/>
                        <SettingsItem itemName={"Payment"} onClick={() => setActiveSideUser(2)} active={activeSideUser === 2}/>
                        <SettingsItem itemName={"Store"} onClick={() => setActiveSideUser(2)} active={activeSideUser === 2}/>
                        <SettingsItem itemName={"Profile"} onClick={() => setActiveSideUser(2)} active={activeSideUser === 2}/>
                        <SettingsItem itemName={"Messageing"} onClick={() => setActiveSideUser(2)} active={activeSideUser === 2}/>
                    ...
                    <section className="user__settings-sidebar-footer">
                        <button className="user__settings-trash-btn">
                            ...
                            <span className="user__settings-trash-btn-text">Trash</span>
                        </button>
                    </section>
                </section>
                ...
                <section className="user__main-sett-container">
                    <div className="user__main-sett-header">
                        <span>the name will appear on your customers billing statement</span>
                        <SuscribeInput />
                    </div>
