...
const Settings = () => {
    const [activeSideUser, setActiveSideUser] = useState(0)
    const settingsItems = [<span className="user__settings-sidebar-header-item-text">"Notification"</span>,
    className="user__settings-sidebar-header-item-text" "Account"className="user__settings-sidebar-header-item-text", "Messaging", "Password", "User Name", "Blocking", "Payment", "Store", "Profile", "Sales"]
    return (
