        ...
        <section>
            ...
            <main>
                ...
                <section className="user__admin-page-section-header-container">
                    ...
                    <IdentityBtn style={{padding: "1rem 6rem", borderLeft: `1rem solid ${activeInpageHeader?"#7C187A":""};`}} dropDownList={true} text={"STORE"}/>
                    <IdentityBtn style={{padding: "1rem 6rem", borderLeft: `1rem solid ${activeInpageHeader?"#7C187A":""}`}} text={"PROFILE"}/>
                    <IdentityBtn style={{padding: "1rem 6rem", borderLeft: `1rem solid ${activeInpageHeader?"#7C187A":""}`}} text={"LIBRARY"}/>
                    <IdentityBtn style={{padding: "1rem 6rem", borderLeft: `1rem solid ${activeInpageHeader?"#7C187A":""}`}} text={"MESSAGES"}/>
                    <IdentityBtn style={{padding: "1rem 6rem", borderLeft: `1rem solid ${activeInpageHeader?"#7C187A":""}`}} text={"SALES"}/>
                    <IdentityBtn style={{padding: "1rem 3rem", borderLeft: `1rem solid ${activeInpageHeader?"#7C187A":""}`}} text={"SETTINGS"}/>
