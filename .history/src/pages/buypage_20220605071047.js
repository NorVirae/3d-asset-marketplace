            ...
            <div className="buy__file-info-container">
                <section className="buy__file-attributed-container">
                    ...
                    <div className="buy__comment-header">
                        <IdentityBtn style={{backgroundColor: "#232230", borderLeft:".5rem", padding:".5rem 4rem"}} text={"Description"} />
                        <IdentityBtn style={{backgroundColor: "#232230", oborderLeft:".5rem", padding:".5rem 4rem"}} text={"18 comments"} />
                    </div>
