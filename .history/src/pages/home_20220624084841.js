            ...
            <div className="landing__app-container">
                ...
                <main className="landing__main">
                        ...
                        <section className="landing__cg-tutorials">
                            <CGBar style={{position: `${yScroll > 1040? "fixed":"sticky"}`, backgroundColor:`${showRegModal.isSidebarOpen? "": "#15151C"}`, maxWidth: `${showRegModal.isSidebarOpen? "100%": "100vw"}`, padding: ``, width: `${showRegModal.isSidebarOpen? "100%": "100vw"}`}}/>
                        </section>
