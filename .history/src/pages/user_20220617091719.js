...
const OrderCheckbox = () => {
    return (
        <div className="user__main-sett-checkbox">
            <div className="user__main-sett-checkbox-active">
                    ...
                    <div className="user__main-sett-body">
                        <div className="user__main-sett-body-left">
                            <div className="user__main-sett-item">
                                ...
                                <div className="user__main-sett-innerbody">
                                    <h4> Order Placed</h4>
                                    <p>Anytime an order is placed you will notified</p>
                                </div>
                            </div>
