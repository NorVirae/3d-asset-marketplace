...
const Sales = () => {
    ...
    return (
        <section className="user__sales">
            <div className="user__sales-inner">

                <section className="user__sales-sidebar">
                    <section className="user__sales-sidebar-header">
                        <div className="user__sales-sidebar-header-item">
                            <span className="user__sales-sidebar-header-item-text">
                                {settingsItems[activeSideUser]}
                            </span>
                        </div>
                    </section>
                    ...
                    <section className="user__sales-sidebar-body">
                        <button className="user__sales-trash-btn">
                            <span className="user__sales-trash-btn-text">Create New Folder</span>
                            <FaPlusCircle  className="user__sales-trash-btn-logo"/> 
                        </button>
                    </section>
                ...
                <section className="user__main-sale-container"> 
                {/* user__main-sale-container */}
        ...
        <section>
            <header>
                ...
                <div style={{backgroundColor: "#15151C", display: "flex", alignItems: "center", height: "5vh", padding: "0px"}}>
                    <CGBarSlim style={{margin: "1rem auto", position: "relative", top: "1vh"}} slim={true}/>
                </div>
            </header>
