...
const CommentSec = () =>{
    const [comm, setComm] = useState([{
        ...
        comment: "Wonder working everything about this piece is epic, expecting more from the creator"
    },
    {
...

    {
        ...
        comment: "This epic details the exudance of great artistry the landmark of Da vinci Larrison fame and Gentility"
    },
    {
            ...
            <div className="buy__comments-listing-container">
                {
                    comm.map(cm => {
                        return (
                            <Comment comment={cm.comment} author={cm.author}/>
    ...
    return (
        <div className="buy__tags-container">
            <div onClick={() => setIsOpen(!isOpen)} className="buy__tag-header">
                <BsTags style={{color: '#FF9700'}}/> Tags <VscTriangleUp className="buy__tag-arrow" style={{color: '#6D6D91', transform: `rotate(${isOpen? '': '180deg 45deg'})`}}/>
            </div>
