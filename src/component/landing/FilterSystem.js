  ...
  return (
    <div className="landing__filter-slider-container">
      ...
      <div className="landing__filter-main-slider">
        <input
          onInput={(e) => handleSliderChange(e, "max")}
          min={"1"}
          max={"100"}
          value={sliderChange.max}
          type={"range"}
          className="landing__filter-slider-max"
        />

        <input
          onInput={(e) => handleSliderChange(e, "min")}
          min={"1"}
          max={"100"}
          value={sliderChange.min}
          type={"range"}
          className="landing__filter-slider-min"
        />
      </div>
      <span className="landing__filter-slide-price">
    ...
    <section className="landing__filter-sytem-container">
      <div className="landing__filter-system-inner-container">
        <div className="landing__filter-headers">
          <span
            onClick={(e) => setActiveFilter("popular")}
          ...
          <span
            onClick={(e) => setActiveFilter("recent")}
            className={`landing__filter-header-item ${
              activeFilter === "recent"
                ? "landing__filter-header-item-active"
                : ""
          ...
          <span
            onClick={(e) => setActiveFilter("freebies")}
            className={`landing__filter-header-item ${
              activeFilter === "freebies"
                ? "landing__filter-header-item-active"
                : ""
            }`}
          >
          ...
          <span
            onClick={(e) => setActiveFilter("sale")}
            className={`landing__filter-header-item ${
              activeFilter === "sale"
                ? "landing__filter-header-item-active"
                : ""
