...
const LoginModal = ({ onClick }) => {
    ...
    return <div onClick={e => e.stopPropagation()} className="lgn__login-modal">
        ...
        <form onSubmit={handleSignIn} onClick={e => e.stopPropagation()} className="lgn__login-form">
            <div className="lgn__form-group">
                <input value={loginInfo.email} onChange={e => setLoginInfo(old => ({...old, email: e.target.value}))} className="lgn__form-control" placeholder="Username / Email" />
            </div>

            <div className="lgn__form-group">
                <input value={loginInfo.password} onChange={e => setLoginInfo(old => ({...old, password: e.target.value}))} type={hidePassword ? "password" : "text"} className="lgn__form-control" placeholder="Password" />
