    ...
    <div className="cart__cart-item-outer">
      ...
      <div className="cart__cart-item">
        ...
        <button className="cart__item-price-btn">
          <span style={{ transform: "skewX(20deg)" }}>$&nbsp;500</span>
        </button>
...
const CustomSelect = () => {
  ...
  return (
    <div className="cart__form-select-skew">
      <div
        onClick={(e) => setSelectToggle(!selectToggle)}
        className="cart__select-preview"
      >
        Nigeria
        <VscTriangleUp
          className="cart__form-arrow"
          style={{
            color: "#6D6D91",
            transform: selectToggle ? "rotate(0deg)" : "rotate(180deg)",
          }}
        />
      </div>
      {selectToggle ? (
        <ul className="cart__country-select">
          <li className="cart__country-select-item">Nigeria</li>
        </ul>
      ) : null}
    </div>
  );
...
const Cart = () => {
  ...
  const [checkboxActiveItems, setCheckboxActiveItems] = [
    false,
    false,
    false,
    false,
  ...
  return (
    <div onClick={handleMainAppClick} className="">
      <header>
        <NavBar
          shortSearch={true}
        ...
        <section className="cart__inner-container">
          <section className="cart__items-container">
            ...
            <div className="cart__cart-items-container">
              <CartItem
                setCheckboxActiveItems={setCheckboxActiveItems}
                checkIndex={0}
                checkBoxActive={checkboxActiveItems[0]}
              />
              <CartItem
                setCheckboxActiveItems={setCheckboxActiveItems}
                checkIndex={1}
                checkBoxActive={checkboxActiveItems[1]}
              />
              <CartItem
                setCheckboxActiveItems={setCheckboxActiveItems}
                checkIndex={2}
                checkBoxActive={checkboxActiveItems[2]}
              />
              <CartItem
                setCheckboxActiveItems={setCheckboxActiveItems}
                checkIndex={3}
                checkBoxActive={checkboxActiveItems[3]}
              />
              <CartItem
                setCheckboxActiveItems={setCheckboxActiveItems}
                checkIndex={4}
                checkBoxActive={checkboxActiveItems[4]}
              />
              <CartItem
                setCheckboxActiveItems={setCheckboxActiveItems}
                checkIndex={5}
                checkBoxActive={checkboxActiveItems[5]}
              />
              <CartItem
                setCheckboxActiveItems={setCheckboxActiveItems}
                checkIndex={6}
                checkBoxActive={checkboxActiveItems[6]}
              />
            </div>
            ...
            <div className="cart__calc-container">
              <div className="cart__subtotal-container">
                ...
                <span className="cart__subtotal-title-price">$1,500</span>
              </div>
            </div>
          </section>
            ...
            <div className="cart__gateway-options-container">
              ...
              <form className="cart__card-insertion-container">
                ...
                <div
                  ...
                  className="buy__purchase-btn-container"
                >
                  <button
